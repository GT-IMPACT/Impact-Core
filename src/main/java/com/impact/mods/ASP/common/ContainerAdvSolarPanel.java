...
public class ContainerAdvSolarPanel extends Container {
  ...
  public ContainerAdvSolarPanel(InventoryPlayer inventoryplayer,
      TileEntitySolarPanel tileentitysolarpanel) {
  ...
  public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
    ...
    if (slotObject != null && slotObject.getHasStack()) {
      ...
      if (par2 >= 0 && par2 <= 3) {
        ...
        if (!this.mergeItemStack(stackInSlot, 0, 4, false) && !this
            .mergeItemStack(stackInSlot, 31, 40, false)) {
          return null;
        }
