//package com.impact.mods.BartWorks;
//
...
//                        Water.getFluid(280),
//                        EnrichedBacterialSludge.getFluid(10),
...
//                },
//                new FluidStack[]{
//                		RadoxPolymerHot.getGas(4320)
//                },
//                (ItemStack[])null,
//                800, BW_Util.getMachineVoltageFromTier(1)
//        );
//
//        GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Ingot.get(0), RadoxPolymerHot.getGas(144), GT_OreDictUnificator.get(OrePrefixes.ingotHot, RadoxPolymer, 1L), 100, 500000);
//        GT_Values.RA.addVacuumFreezerRecipe(GT_OreDictUnificator.get(OrePrefixes.ingotHot,RadoxPolymer,1L), GT_OreDictUnificator.get(OrePrefixes.ingot,RadoxPolymer,1L),200,500000);
//
