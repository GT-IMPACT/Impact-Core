...
import com.impact.mods.nei.oreplugin.PluginGT5VeinStat;
  ...
  public void runSmallOres() {
    try {
      ...
      while (it.hasNext()) {
        ...
        GT5OreSmallHelper.OreSmallWrapper oreLayer = (GT5OreSmallHelper.OreSmallWrapper) pair
            .getValue();
      ...
      BufferedWriter one = Files.newBufferedWriter(
          Paths.get(event.getModConfigurationDirectory() + "/Small-Ores-Sheet.csv"));
      ColumnPositionMappingStrategy strat = new ColumnPositionMappingStrategy();
      strat.setType(Oremix.class);
      String[] columns = "ORENAME,mix,DENSITY,overworld,nether,end,ea,aroma,tf,mo,ma,ph,de,as,ce,eu,ga,ca,io,ve,me,en,ti,mi,ob,pr,tr,pl,kb,ha,make,dd,cb,vb,bc,be,bf,tcetie"
          .split("\\,");
      ...
      one.write(
          "Ore Name,Primary,Secondary,Inbetween,Around,ID,Tier,Height,Density,Size,Weight,Overworld,Nether,End,End Asteroids,Aroma World,Twilight Forest,Moon,Mars,Phobos,Deimos,Asteroids,Ceres,Europa,Ganymede,Callisto,Io,Venus,Mercury,Enceladus,Titan,Miranda,Oberon,Proteus,Triton,Pluto,Kuiper Belt,Haumea,Makemake,Deep Dark,Centauri Bb,Vega B,Barnard C,Barnard E,Barnard F,T Ceti E");
      one.newLine();
  ...
  public void runVeins() {
    try {
      ...
      while (it.hasNext()) {
        ...
        GT5OreLayerHelper.OreLayerWrapper oreLayer = (GT5OreLayerHelper.OreLayerWrapper) pair
            .getValue();
        ...
        oremix.setMix(
            Integer.toString(oreLayer.Meta[0]) + "|" + Integer.toString(oreLayer.Meta[1]) + "|"
      ...
      BufferedWriter one = Files
          .newBufferedWriter(Paths.get(event.getModConfigurationDirectory() + "/Oresheet.csv"));
      ColumnPositionMappingStrategy strat = new ColumnPositionMappingStrategy();
      strat.setType(Oremix.class);
      String[] columns = "ORENAME,PRIMARY,SECONDARY,INBETWEEN,AROUND,mix,TIER,HEIGHT,DENSITY,SIZE,WEIGHT,overworld,nether,end,aroma,ea,tf,mo,ma,ph,de,as,ce,eu,ga,ca,io,ve,me,en,ti,mi,ob,pr,tr,pl,kb,ha,make,dd,cb,vb,bc,be,bf,tcetie"
          .split("\\,");
      strat.setColumnMapping(columns);
      StatefulBeanToCsv<Oremix> beanToCsv = new StatefulBeanToCsvBuilder(one)
          .withQuotechar(CSVWriter.NO_QUOTE_CHARACTER)
