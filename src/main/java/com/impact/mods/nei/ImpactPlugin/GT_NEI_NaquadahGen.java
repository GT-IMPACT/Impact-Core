...
public class GT_NEI_NaquadahGen extends TemplateRecipeHandler {
  ...
  public GT_NEI_NaquadahGen(
      GT_Recipe.GT_Recipe_Map aRecipeMap) {//this is called when recipes should be shown
    this.mRecipeMap = aRecipeMap;
    this.transferRects.add(
        new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(75, 32, 18, 18),
            getOverlayIdentifier(), new Object[0]));
  ...
  public void drawExtras(int aRecipeIndex) {
    String[] recipeDesc = ((CachedDefaultRecipe) this.arecipes.get(aRecipeIndex)).mRecipe
        .getNeiDesc();
    if (recipeDesc == null) {
      int tSpecial = ((GT_NEI_NaquadahGen.CachedDefaultRecipe) this.arecipes
