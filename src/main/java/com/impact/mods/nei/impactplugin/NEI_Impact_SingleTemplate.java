...
public abstract class NEI_Impact_SingleTemplate extends TemplateRecipeHandler {
  ...
  public NEI_Impact_SingleTemplate(int[] Reactangle, ItemStack[] Inputs, int[] xPosInputs,
      int[] yPosInputs, ItemStack[] Outputs, int[] xPosOutputs, int[] yPosOutputs,
      boolean OverGUI) {
    ...
    amOverGUI = OverGUI;
    this.transferRects.add(new RecipeTransferRect(
        new Rectangle(amReactangle[0], amReactangle[1], amReactangle[2], amReactangle[3]),
    ...
    public CachedDefaultRecipe() {
      ...
      if (amOutputs != null) {
        if (amOutputs.length == 1) {
          this.mOutputs
              .add(new FixedPositionedStack(amOutputs[0], amXPosOutputs[0], amYPosOutputs[0]));
        } else if (amOutputs.length == 2) {
          this.mOutputs
              .add(new FixedPositionedStack(amOutputs[0], amXPosOutputs[0], amYPosOutputs[0]));
          this.mOutputs
              .add(new FixedPositionedStack(amOutputs[1], amXPosOutputs[1], amYPosOutputs[1]));
          ...
          this.mOutputs
              .add(new FixedPositionedStack(amOutputs[1], amXPosOutputs[1], amYPosOutputs[1]));
          this.mOutputs
              .add(new FixedPositionedStack(amOutputs[2], amXPosOutputs[2], amYPosOutputs[2]));
        }
      }
    }
