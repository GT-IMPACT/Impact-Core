...
public class GT_Materials implements IMaterialHandler {
    ...
    *   256 = Designates something as empty (only used for the Empty material)/
    ...
    public static Materials Zamak = new Materials               ( 40, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 43 ,117,222,0,"Zamak",             "Zamak",               0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  3, Arrays.asList(new MaterialStack(Materials.Aluminium,4), new MaterialStack(Materials.Copper,3), new MaterialStack(Materials.Magnesium,1))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    ...
    public static Materials Inconel690 = new Materials          ( 42, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 221,238,1  ,0,"Inconel-690",       "Inconel-690",         0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  3, Arrays.asList(new MaterialStack(Materials.Chrome,1), new MaterialStack(Materials.Niobium,2), new MaterialStack(Materials.Molybdenum,2), new MaterialStack(Materials.Nichrome,1))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials Nitinol = new Materials             ( 43, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 164,250,108,0,"Nitinol",           "Nitinol",             0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  2, Arrays.asList(new MaterialStack(Materials.Titanium,1), new MaterialStack(Materials.Nickel,1))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials Inconel792 = new Materials          ( 44, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 35 ,52 ,148,0,"Inconel-792",       "Inconel-792",         0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  4, Arrays.asList(new MaterialStack(Materials.Nickel,2), new MaterialStack(Materials.Niobium,1), new MaterialStack(Materials.Aluminium,2), new MaterialStack(Materials.Nichrome,1))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials TiBetaC = new Materials             ( 46, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 161,197,163,0,"TiBetaC",           "TiBetaC",             0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  6, Arrays.asList(new MaterialStack(Materials.Titanium,2), new MaterialStack(Materials.Aluminium,3), new MaterialStack(Materials.Vanadium,8), new MaterialStack(Materials.Chrome,6), new MaterialStack(Materials.Molybdenum,4), new MaterialStack(Zirconium,4))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials MaragingSteel250 = new Materials    ( 49, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 242,242,182,0,"MaragingSteel250",  "Maraging Steel 250",  0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  5, Arrays.asList(new MaterialStack(Materials.Steel,16), new MaterialStack(Materials.Titanium,1), new MaterialStack(Materials.Aluminium,1), new MaterialStack(Materials.Nickel,4), new MaterialStack(Materials.Cobalt,2))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials Talonite = new Materials            ( 50, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 1  ,29 ,66 ,0,"Talonite",          "Talonite",            0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  5, Arrays.asList(new MaterialStack(Materials.Cobalt,4), new MaterialStack(Materials.Chrome,3), new MaterialStack(Materials.Phosphor,2), new MaterialStack(Materials.Molybdenum,1))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials Grisium = new Materials             ( 51, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 67 ,88 ,221,0,"Grisium",           "Grisium",             0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  5, Arrays.asList(new MaterialStack(Materials.Titanium,9), new MaterialStack(Materials.Carbon,9), new MaterialStack(Materials.Kalium,9), new MaterialStack(Materials.Lithium,9), new MaterialStack(Materials.Sulfur,9))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials Nitinol60 = new Materials           ( 53, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 122,235,112,0,"Nitinol-60",        "Nitinol-60",          0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  2, Arrays.asList(new MaterialStack(Materials.Nickel,2), new MaterialStack(Materials.Titanium,3))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials Kovar = new Materials               ( 59, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 203,192,166,0,"Kovar",             "Kovar",               0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  3, Arrays.asList(new MaterialStack(Materials.Iron,5), new MaterialStack(Materials.Nickel,3), new MaterialStack(Materials.Cobalt,2))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials Mangalloy = new Materials           ( 60, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 57 ,152,213,0,"Mangalloy",         "Mangalloy",           0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  2, Arrays.asList(new MaterialStack(Materials.Steel,5), new MaterialStack(Materials.Manganese,2))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
    public static Materials MaragingSteel300 = new Materials    ( 61, TextureSet.SET_SHINY,128.0F,51200,8,2|128, 99 ,112,135,0,"MaragingSteel300",  "Maraging Steel 300",  0,0,10000,7200,false, false,4,1,1, Dyes.dyeRed,  5, Arrays.asList(new MaterialStack(Materials.Steel,16), new MaterialStack(Materials.Titanium,1), new MaterialStack(Materials.Aluminium,1), new MaterialStack(Materials.Nickel,4), new MaterialStack(Materials.Cobalt,2))).disableAutoGeneratedBlastFurnaceRecipes().setHasCorrespondingMoltenHot(true);
