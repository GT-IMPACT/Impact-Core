...
public class GT_Materials implements IMaterialHandler {
    ...
    *   256 = Designates something as empty (only used for the Empty material)/
    ...
    public static void MaterialsStatic() {
        ...
        Potin = new Materials               ( 75, TextureSet.SET_SHINY,128.0F,51200,8,2,     201,151,129,0,"Potin",             "Potin",               0,0,0,0,false, false,4,1,1, Dyes.dyeRed,  3, Arrays.asList(new MaterialStack(Materials.Lead,40), new MaterialStack(Materials.Bronze,40), new MaterialStack(Materials.Tin,20))).disableAutoGeneratedBlastFurnaceRecipes(); //Pb40Bronze40Sb20
        ...
        /** FLUID */
        SupercriticalSteam = new MaterialBuilder(11, TextureSet.SET_FLUID, "Supercritical Steam").addCell().addFluid().setRGB(32, 32, 32).setColor(Dyes.dyeGray).setFuelType(MaterialBuilder.NUKE).setFuelPower(16).constructMaterial();
