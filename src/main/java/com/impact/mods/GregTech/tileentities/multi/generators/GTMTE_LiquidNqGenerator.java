    ...
    for (byte X = -3; X <= 3; X++) {
      for (byte Y = -3; Y <= 3; Y++) {
        for (int Z = -1; Z >= -5; Z--) {
          ...
          if ((Y >= -1 && Y <= 1 && (X == 3 || X == -3)) || (X >= -1 && X <= 1 && (Y == 3
              || Y == -3))) {
          ...
          if ((X >= -2 && X <= 2 && Y >= -2 && Y <= 2) && !(X == 2 && Y == 2 || X == -2 && Y == 2
              || X == 2 && Y == -2 || X == -2 && Y == -2)) {
      ...
      registerMetaClass(GTMTE_LiquidNqGenerator.class,
          new IMultiblockInfoContainer<GTMTE_LiquidNqGenerator>() {
            ...
            private final IStructureDefinition<GTMTE_LiquidNqGenerator> definition =
                StructureDefinition.<GTMTE_LiquidNqGenerator>builder()
                    .addShape("main", new String[][]{
                        {"       ", " 00 00 ", " 0   0 ", "       ", " 0   0 ", " 00 00 ",
                            "       "},
                        {"  000  ", " 00000 ", "0000000", "000~000", "0000000", " 00000 ",
                            "  000  "},
                        {"  222  ", " 0   0 ", "2 1 1 2", "2 131 2", "2 1 1 2", " 0   0 ",
                            "  222  "},
                        {"  222  ", " 0   0 ", "2     2", "2     2", "2     2", " 0   0 ",
                            "  222  "},
                        {"  222  ", " 0   0 ", "2     2", "2     2", "2     2", " 0   0 ",
                            "  222  "},
                        {"  222  ", " 0   0 ", "2     2", "2     2", "2     2", " 0   0 ",
                        ...
                        {"  222  ", " 0   0 ", "2 1 1 2", "2 131 2", "2 1 1 2", " 0   0 ",
                            "  222  "},
                        {"  000  ", " 00000 ", "0000000", "0000000", "0000000", " 00000 ",
                            "  000  "},
            ...
            public void construct(ItemStack stackSize, boolean hintsOnly,
                GTMTE_LiquidNqGenerator tileEntity, ExtendedFacing aSide) {
