...
public class GTMTE_MoonMiner extends GT_MetaTileEntity_MultiParallelBlockBase {
  ...
  public void run() {
    registerMetaClass(GTMTE_MoonMiner.class, new IMultiblockInfoContainer<GTMTE_MoonMiner>() {
      ...
      @Override
      public void construct(ItemStack stackSize, boolean hintsOnly, GTMTE_MoonMiner tileEntity,
  ...
  public void onPostTick(IGregTechTileEntity aBaseMetaTileEntity, long aTick) {
    ...
    if (aTick % 20 == 0 && getBaseMetaTileEntity().isActive()) {
      addOutput(Blockstack(GCBlocks.blockMoon,
          (Math.max(1, GT_Utility.getTier(getMaxInputVoltage())) - 1), rand.nextInt(3) + 3));
    }
  }
