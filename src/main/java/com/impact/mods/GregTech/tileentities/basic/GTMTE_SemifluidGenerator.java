...
public class GTMTE_SemifluidGenerator
    ...
    public GTMTE_SemifluidGenerator(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GTMTE_SemifluidGenerator(this.mName, this.mTier, this.mDescriptionArray, this.mTextures);
    }
