...
public class ChestCartEntities {
  ...
  public static void init() {
    EntityRegistry
        .registerModEntity(EntitySteelChestCart.class, "EntityIronChestCart", 1, impact.instance,
            80, 3, true);
    EntityRegistry
        .registerModEntity(EntityAlChestCart.class, "EntityGoldChestCart", 2, impact.instance, 80,
            3, true);
    EntityRegistry
        .registerModEntity(EntityWIronChestCart.class, "EntityCopperChestCart", 3, impact.instance,
            80, 3, true);
  }
}
