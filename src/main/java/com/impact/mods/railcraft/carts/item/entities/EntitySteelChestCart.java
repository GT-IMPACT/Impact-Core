...
public class EntitySteelChestCart extends EntityExtraCartChestMinecart implements OpenableGUI,
    IMinecart {
  ...
  public boolean doesCartMatchFilter(ItemStack stack, EntityMinecart cart) {
    ...
    if (cart instanceof EntitySteelChestCart && stack.getItem() == CartStack.getItem()
