...
public class GuiSteelChestCart extends GuiContainer {

    private static final ResourceLocation ChestTexture = new ResourceLocation("chestup", "textures/gui/steel.png");

    public GuiSteelChestCart(IInventory invPlayer, IInventory cart) {
        super(new ContainerSteelChestCart(invPlayer, cart));
        this.ySize = 256;
        this.xSize = 177;
    }
