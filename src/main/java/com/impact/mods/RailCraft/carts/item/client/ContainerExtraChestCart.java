    ...
    public ContainerExtraChestCart(IInventory invPlayer, IInventory cart, int xSize, int ySize, int rows, int columns) {
        ...
        switch (rows) {
            case 5:
                for (hotbarSlot = 0; hotbarSlot < rows; ++hotbarSlot) {
                    for (playerInvCol = 0; playerInvCol < columns; ++playerInvCol) {
                        addSlotToContainer(new Slot(cart, playerInvCol + hotbarSlot * columns, 8 + playerInvCol * 18, 18 + hotbarSlot * 18));
                    }
                }

                for (hotbarSlot = 0; hotbarSlot < 3; ++hotbarSlot) {
                    for (playerInvCol = 0; playerInvCol < 9; ++playerInvCol) {
                        addSlotToContainer(new Slot(invPlayer, playerInvCol + hotbarSlot * 9 + 9, leftCol + playerInvCol * 18, ySize - (4 - hotbarSlot) * 18 - 6));
                    }
                }

                for (hotbarSlot = 0; hotbarSlot < 9; ++hotbarSlot) {
                    addSlotToContainer(new Slot(invPlayer, hotbarSlot, leftCol + hotbarSlot * 18, ySize - 20));
                }
                return;
            ...
            case 7:
                ...
                for (hotbarSlot = 0; hotbarSlot < 3; ++hotbarSlot) {
                    for (playerInvCol = 0; playerInvCol < 9; ++playerInvCol) {
                        addSlotToContainer(new Slot(invPlayer, playerInvCol + hotbarSlot * 9 + 9, leftCol + playerInvCol * 18, ySize - (4 - hotbarSlot) * 18 - 36));
                    }
                }

                for (hotbarSlot = 0; hotbarSlot < 9; ++hotbarSlot) {
                    addSlotToContainer(new Slot(invPlayer, hotbarSlot, leftCol + hotbarSlot * 18, ySize - 50));
                }
                return;
            ...
            default:
                ...
                for (hotbarSlot = 0; hotbarSlot < 3; ++hotbarSlot) {
                    for (playerInvCol = 0; playerInvCol < 9; ++playerInvCol) {
                        addSlotToContainer(new Slot(invPlayer, playerInvCol + hotbarSlot * 9 + 9, leftCol + playerInvCol * 18, ySize - (4 - hotbarSlot) * 18 - 56));
                    }
                }

                for (hotbarSlot = 0; hotbarSlot < 9; ++hotbarSlot) {
                    addSlotToContainer(new Slot(invPlayer, hotbarSlot, leftCol + hotbarSlot * 18, ySize - 70));
                }
        }
    }
