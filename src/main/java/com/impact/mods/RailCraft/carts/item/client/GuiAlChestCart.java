...
public class GuiAlChestCart extends GuiContainer {
    private static final ResourceLocation ChestTexture = new ResourceLocation("chestup", "textures/gui/aluminium.png");

    public GuiAlChestCart(IInventory invPlayer, IInventory cart) {
        super(new ContainerAlChestCart(invPlayer, cart));
        this.ySize = 312;
        this.xSize = 177;
    }
