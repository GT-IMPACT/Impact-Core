...
import static com.impact.mods.gregtech.enums.Texture.Icons.SAW;
import static com.impact.mods.gregtech.enums.Texture.Icons.SAW_ACTIVE;
import static com.impact.mods.gregtech.enums.Texture.Icons.SAW_FRONT;
import static com.impact.mods.gregtech.enums.Texture.Icons.SAW_FRONT_ACTIVE;
...
public class GTMTE_SawMill extends GT_MetaTileEntity_MultiParallelBlockBase {
  ...
  public ITexture[] getTexture(final IGregTechTileEntity aBaseMetaTileEntity, final byte aSide,
    ...
    return aSide == aBaseMetaTileEntity.getBackFacing()
        ...
        : aSide == aFacing
            ...
            new GT_RenderedTexture(aActive ? SAW_FRONT_ACTIVE : SAW_FRONT)}
            : new ITexture[]{INDEX_CASE};
  }
  ...
  public GT_Recipe.GT_Recipe_Map getRecipeMap() {
    return mMode == 0 ? GT_Recipe.GT_Recipe_Map.sSawMill0
        : mMode == 1 ? GT_Recipe.GT_Recipe_Map.sSawMill1 : GT_Recipe.GT_Recipe_Map.sSawMill2;
  }
  ...
  public void onScrewdriverRightClick(byte aSide, EntityPlayer aPlayer, float aX, float aY,
    ...
    mModed = (mMode == 0 ? " Planks & Sawdust "
        : mMode == 1 ? " Wood Pulp & Sawdust " : " Only Sawdust ");
