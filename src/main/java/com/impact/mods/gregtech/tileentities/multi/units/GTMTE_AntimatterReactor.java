...
public class GTMTE_AntimatterReactor extends GT_MetaTileEntity_MultiParallelBlockBase<GTMTE_AntimatterReactor> {
	...
	protected MultiBlockTooltipBuilder createTooltip() {
		...
		b
				...
				.addMaintenanceHatch()
				.addCasingInfo("case.1", "Radiation Proof Casing")
				.addCasingInfo("case.5", "Intermix Chamber Casing")
				.addCasingInfo("case.0", "Magnetic Coil Block")
				.addCasingInfo("case.2", "Dyson Ring Casing")
				.addCasingInfo("case.3", "Fusion Casing MKII")
