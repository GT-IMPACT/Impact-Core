...
public class GTMTE_TinyWormHole extends GT_MetaTileEntity_MultiParallelBlockBase<GTMTE_TinyWormHole> {
	...
	protected MultiBlockTooltipBuilder createTooltip() {
		...
		b
				...
				.addCasingInfo("case.1", "Dyson Ring Casing")
				.addCasingInfo("case.2", "Fusion Casing MKII")
				.addCasingInfo("case.3", "Fusion Coil Block")
				.addCasingInfo("case.4", "Core Chamber Casing")
				.addHints()
