...
abstract class GTMTE_SOFC extends GT_MetaTileEntity_MultiBlockBase {
	...
	public String[] getInfoData() {
		...
		return new String[]{StatCollector.translateToLocal("GT5U.engine.output") + ": " + EnumChatFormatting.GREEN + this.mEUt * this.mEfficiency / 10000 + EnumChatFormatting.RESET + " EU/t", StatCollector.translateToLocal("GT5U.engine.efficiency") + ": " + EnumChatFormatting.YELLOW + (float) this.mEfficiency / 100.0F + EnumChatFormatting.YELLOW + " %", (getTier() == 0 ? "Output Steam: " : "Output SH Steam: ") + (((float) this.mEfficiency / 100.0F == 100) ? EnumChatFormatting.GREEN + "" + STEAM_PER_SEC[getTier()] + EnumChatFormatting.RESET + " L/s" : EnumChatFormatting.GREEN + "0" + EnumChatFormatting.RESET + " L/s"), "Maintenance: " + ((super.getRepairStatus() == super.getIdealStatus()) ? EnumChatFormatting.GREEN + "No Problems" + EnumChatFormatting.RESET : EnumChatFormatting.RED + "Has Problems" + EnumChatFormatting.RESET), "Fuel supply: " + ((this.mEUt * this.mEfficiency / 10000 >= 1) ? EnumChatFormatting.RED + "" + fuelConsumption + EnumChatFormatting.RESET + " L/s" : EnumChatFormatting.RED + "0" + EnumChatFormatting.RESET + " L/s"), "Oxygen supply: " + ((this.mEUt * this.mEfficiency / 10000 >= 1) ? EnumChatFormatting.RED + "" + OXYGEN_PER_SEC[getTier()] + EnumChatFormatting.RESET + " L/s" : EnumChatFormatting.RED + "0" + EnumChatFormatting.RESET + " L/s")};
	}
