...
public class ImpactGuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new ImpactGuiButton(20, xButtons - 25-5, yButtons + 84 + 42 - 25, 50, 20, I18n.format("Website")));
        this.buttonList.add(new ImpactGuiButton(21, xButtons + 25, yButtons + 84 + 42 - 25, 50, 20, I18n.format("Discord")));
        this.buttonList.add(new ImpactGuiButton(22, xButtons + 75+5, yButtons + 84 + 42 - 25, 50, 20, I18n.format("GitHub")));
    }
    ...
    protected void actionPerformed(GuiButton b) {
        ...
        if (b.id == 3) urlopen("https://forum.micdoodle8.com/index.php?threads/1-7-10-galaxy-space-stable.5298/");
        if (b.id == 4) this.mc.shutdown();
        if (b.id == 5) this.mc.displayGuiScreen(new GuiLanguage(this, this.mc.gameSettings, this.mc.getLanguageManager()));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.fontRendererObj, eBug1, this.width - this.fontRendererObj.getStringWidth(eBug1) - 2, this.height - 20, -1);
        drawString(this.fontRendererObj, eBug2, this.width - this.fontRendererObj.getStringWidth(eBug2) - 2, this.height - 10, -1);
        } catch (IOException e) {
            e.printStackTrace();
        }
