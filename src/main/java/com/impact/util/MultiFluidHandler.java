...
public class MultiFluidHandler {
    ...
    public final int maxDistinctFluids;
    public final int capacityPerFluid;

    public boolean locked = true;
    public boolean doVoidExcess = false;
    public byte fluidSelector = -1;

    public MultiFluidHandler(int maxDistinctFluids, int capacityPerFluid, List<FluidStack> fluidsToAdd) {
     ...
     *
     * @param maxDistinctFluids How many different fluids can be stored
     * @param capacityPerFluid  How much capacity each fluid should have
     * @param fluidsToAdd       Fluids to add immediately
     ...
     *
     * @param toCopy           The MultiFluidHandler that should be copied
     * @param capacityPerFluid How much capacity each fluid should have
     * @return A new instance
     */
     ...
     *
     * @param fluidSelector Selected fluid or -1 if no fluid is selected
     */
    ...
    /**
     * @return Selected fluid or -1 if no fluid is selected
     */
     ...
     * @return deep copy of the requested FluidStack
     */
     ...
     *
     * @return amount of different fluids currently stored (0-25)
     */
    ...
    public MultiFluidHandler loadNBTData(NBTTagCompound nbt) {
        ...
        final int capacityPerFluid = nbt.getInteger("capacity");
    ...
    public int pushFluid(FluidStack push, boolean doPush) {
        ...
        if (fluids.size() == maxDistinctFluids && !contains(push)) {
            ...
            if (doPush) {
                fluids.add(new FluidStack(push.getFluid(), (int) fit));
            }
