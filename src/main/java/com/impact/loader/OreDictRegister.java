...
public class OreDictRegister {
  ...
  public static void register_space_rocks() {
    ...
    if (Loader.isModLoaded("GalaxySpace")) {
      ...
      reg_rock(OreDictTypes.Enceladus.name(),
  ...
  public static void reg_additional() {
    if (Loader.isModLoaded("GalaxySpace")) {
      for (int i = 0; i < 6; i++) {
        OreDictionary.registerOre("cropSpace",
            GT_ModHandler.getModItem("GalaxySpace", "tcetiedandelions", 1L, i));
        OreDictionary.registerOre("cropTcetiESeaweed",
            GT_ModHandler.getModItem("GalaxySpace", "tcetiedandelions", 1L, i));
      }
    }
    OreDictionary
    ...
    OreDictionary.registerOre("oreIlmenite",
    ...
    OreDictionary.registerOre("dustSilicon",
        GT_ModHandler.getModItem("GalacticraftCore", "item.basicItem", 1L, 2));
    OreDictionary
