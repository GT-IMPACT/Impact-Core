...
public class MixinPlugin implements IMixinConfigPlugin {
	...
	public List<String> getMixins() {
		...
		List<TargetedMod> loadedMods = Arrays.stream(TargetedMod.values()).filter(mod -> mod == VANILLA || (mod.loadInDevelopment && isDevelopmentEnvironment) || loadJarOf(mod)).collect(Collectors.toList());
