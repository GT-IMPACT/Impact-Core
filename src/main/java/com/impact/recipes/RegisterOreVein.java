...
public class RegisterOreVein implements Runnable{
    ...
    public void registerOres() {
        addRegisterOre(BiomeGenBase.ocean, typeOre(29), typeOre(48), typeOre(817), typeOre(534), typeOre(943));
        addRegisterOre(BiomeGenBase.plains, typeOre(944), typeOre(502), typeOre(503), typeOre(504), typeOre(810));
    ...
    public void addRegisterOre(BiomeGenBase biome, ItemStack... itemStack) {
        ...
        impact.I_RA.addVeinOres(Impact_API.sBiomeOres.get(biome), RegisterOreVein.mBiomeToInteger.get(biome));
    }
