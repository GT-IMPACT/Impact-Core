...
public class EnderIORecipe implements Runnable {
  ...
  public void assemblerRecipe() {
    ...
    GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Conveyor_Module_MV.get(1),
            ...
            new ItemStack(EnderIO.itemMaterial, 8, 1), GT_Utility.getIntegratedCircuit(1)}, null,
        new ItemStack(EnderIO.itemItemConduit, 8, 0), 140, 30);
    ...
    GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Conveyor_Module_EV.get(1),
            ...
            new ItemStack(EnderIO.itemMaterial, 32, 1), GT_Utility.getIntegratedCircuit(1)}, null,
        new ItemStack(EnderIO.itemItemConduit, 32, 0), 180, 96);
