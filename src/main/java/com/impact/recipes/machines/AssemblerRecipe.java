...
/** ================================= start IMPACT MOD =================================*/
        //Casings
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.GumMetal, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titaniolum, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.PBECasing.get(1), 200, 1920);
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Inconel690, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Nitinol, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.AssemblerCasing.get(1), 200, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Inconel792, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TiBetaC, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.CentrifugeCasing.get(1), 200, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.HastelloyC276, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Zamak, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.ElectrolyzerCasing.get(1), 200, 1920);
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.MaragingSteel250, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Inconel792, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.SupplyProductionCasing.get(1), 200, 1920);
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Nitinol60, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Kovar, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.ArcCasing.get(1), 200, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.TiBetaC, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Talonite, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.ExtradificationCasing.get(1), 200, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Titaniolum, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.MaragingSteel250, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.MixingCasing.get(1), 200, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.HastelloyC276, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Mangalloy, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.MacerationCasing.get(1), 200, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.MaragingSteel300, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Stellite, 6), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSG, 16)}, Materials.HSSE.getMolten(288L), GT_ItemList.CuttingCasing.get(1), 200, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Machine_HV_Printer.get(1L),/*GT_ModHandler.getModItem("OpenComputers", "printer", 1L, 0), */ItemList.Cover_Crafting.get(1L), ItemList.Conveyor_Module_HV.get(2L), GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 4), GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.BlackSteel, 8), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.StainlessSteel, 16)}, Materials.SolderingAlloy.getMolten(288L), GT_ItemList.Machine_DDDPrinter.get(1), 200, 480);
...
*/
        ...
        //Portable Tank
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Lead, 8), ItemList.Large_Fluid_Cell_Steel.get(1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L)}, GT_Values.NF, GT_ItemList.Portable_Tank_ULV.get(1L), 100, 6);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 8), ItemList.Large_Fluid_Cell_Aluminium.get(1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L)}, GT_Values.NF, GT_ItemList.Portable_Tank_LV.get(1L), 200, 30);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 8), ItemList.Large_Fluid_Cell_StainlessSteel.get(1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L)}, GT_Values.NF, GT_ItemList.Portable_Tank_MV.get(1L), 300, 120);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSLA, 8), ItemList.Large_Fluid_Cell_Titanium.get(1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L)}, GT_Values.NF, GT_ItemList.Portable_Tank_HV.get(1L), 400, 480);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSG, 8), ItemList.Large_Fluid_Cell_TungstenSteel.get(1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L)}, GT_Values.NF, GT_ItemList.Portable_Tank_EV.get(1L), 500, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HastelloyC276, 8), ItemList.Large_Fluid_Cell_Chrome.get(1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L)}, GT_Values.NF, GT_ItemList.Portable_Tank_IV.get(1L), 600, 7680);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HastelloyN, 8), ItemList.Large_Fluid_Cell_Iridium.get(1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L)}, GT_Values.NF, GT_ItemList.Portable_Tank_LuV.get(1L), 700, 30720);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Lafium, 8), ItemList.Large_Fluid_Cell_Osmium.get(1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L)}, GT_Values.NF, GT_ItemList.Portable_Tank_ZPM.get(1L), 800, 122880);
...
/** ================================= start GT MOD =================================*/
        if (!(GT_Mod.gregtechproxy.mComponentAssembler)) {
            ...
            //Pistons
            GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ItemList.ULVMotor.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 3), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.WroughtIron, 2), GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Lead, 2), GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.WroughtIron, 1)}, GT_Values.NF, GT_ItemList.ULVPiston.get(1L), 100, 8);
        ...
        /* ==== END AE/EC2 ==== */
        /** ==== START CHESTUP ==== */
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 8), GT_ModHandler.getModItem("minecraft", "chest", 1L), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 0), 80, 8);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 8), GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 0), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 1), 90, 16);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 8), GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 2), 100, 64);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSLA, 8), GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 2), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 3), 110, 256);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 8), GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 3), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 4), 120, 1024);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 8), GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 4), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 5), 130, 4096);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Chrome, 8), GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 5), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 6), 140, 16384);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 8), GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 6), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 7), 150, 65536);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium, 8), GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 7), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 8), 160, 262144);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 8), GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 8), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 9), 170, 1048576);

        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Wood, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "WOODWRIRONUpgrade", 1L, 0), 80, 8);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "WRIRONSTEELUpgrade", 1L, 0), 90, 16);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "STEELALUMINIUMUpgrade", 1L, 0), 100, 64);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSLA, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "ALUMINIUMHSLAUpgrade", 1L, 0), 110, 256);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSLA, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "HSLATITANIUMUpgrade", 1L, 0), 120, 1024);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "TITANIUMWOLFRAMUpgrade", 1L, 0), 130, 4096);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Chrome, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "WOLFRAMCHROMEUpgrade", 1L, 0), 140, 16384);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Chrome, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "CHROMEIRIDIUMUpgrade", 1L, 0), 150, 65536);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "IRIDIUMOSMIUMUpgrade", 1L, 0), 160, 262144);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium, 1), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("chestup", "OSMIUMNEUTRONIUMUpgrade", 1L, 0), 170, 1048576);
        ...
        // --- Fence Gate Acacia
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 4), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("malisisdoors", "acaciaFenceGate", 1L), 300, 8);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 4), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(2)}, Materials.Iron.getMolten(16), GT_ModHandler.getModItem("malisisdoors", "acaciaFenceGate", 2L), 300, 8);
        ...
        // --- Fence Gate Birch
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 2), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("malisisdoors", "birchFenceGate", 1L), 300, 8);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 2), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(2)}, Materials.Iron.getMolten(16), GT_ModHandler.getModItem("malisisdoors", "birchFenceGate", 2L), 300, 8);
        ...
        // --- Fence Gate Dark Oak
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 5), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("malisisdoors", "darkOakFenceGate", 1L), 300, 8);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 5), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(2)}, Materials.Iron.getMolten(16), GT_ModHandler.getModItem("malisisdoors", "darkOakFenceGate", 2L), 300, 8);
        ...
        // --- Fence Gate Jungle
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 3), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("malisisdoors", "jungleFenceGate", 1L), 300, 8);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 3), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(2)}, Materials.Iron.getMolten(16), GT_ModHandler.getModItem("malisisdoors", "jungleFenceGate", 2L), 300, 8);
        ...
        // --- Fence Gate Spruce
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 1), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("malisisdoors", "spruceFenceGate", 1L), 300, 8);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L, 1), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(2)}, Materials.Iron.getMolten(16), GT_ModHandler.getModItem("malisisdoors", "spruceFenceGate", 2L), 300, 8);
        ...
        // --- Fence Gate Oak
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("minecraft", "fence_gate", 1L), 300, 8);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_ModHandler.getModItem("minecraft", "planks", 3L), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L), GT_Utility.getIntegratedCircuit(2)}, Materials.Iron.getMolten(16), GT_ModHandler.getModItem("minecraft", "fence_gate", 2L), 300, 8);
        ...
        // --- Ladder
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 3L), GT_Utility.getIntegratedCircuit(4)}, null, GT_ModHandler.getModItem("minecraft", "ladder", 2L), 400, 4);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 3L), GT_Utility.getIntegratedCircuit(5)}, Materials.Iron.getMolten(16), GT_ModHandler.getModItem("minecraft", "ladder", 4L), 400, 4);
