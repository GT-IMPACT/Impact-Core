...
public class AssemblerRecipe implements Runnable {
  ...
  public void run() {
    ...
    GT_Values.RA
        .addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 8L),
            ItemList.Casing_Tank_0.get(1L),
            GT_ModHandler.getModItem("impact", "WroughtIronChest", 1L), 200, 16);
...
*/
    ...
    GT_Values.RA.addAssemblerRecipe(
        ...
        GT_ItemList.GoldCoreChip.get(1L), GT_ItemList.LogicProcessorItemGoldCore.get(1L), 100, 480);
    GT_Values.RA.addAssemblerRecipe(
        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24),
        GT_ItemList.DiamondCoreChip.get(1L),
        GT_ItemList.EngineeringProcessorItemDiamondCore.get(1L), 100, 1920);
    GT_Values.RA.addAssemblerRecipe(
        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24),
        GT_ItemList.EmeraldAdvancedCoreChip.get(1L),
        GT_ItemList.EngineeringProcessorItemEmeraldCore.get(1L), 100, 4096);
    GT_Values.RA.addAssemblerRecipe(
        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24),
        GT_ItemList.EmeraldHighAdvancedCoreChip.get(1L),
        GT_ItemList.EngineeringProcessorItemAdvEmeraldCore.get(1L), 100, 30720);

    GT_Values.RA.addAssemblerRecipe(
        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24),
        GT_ItemList.GoldFluidCoreChip.get(1L),
        GT_ItemList.EngineeringProcessorFluidGoldCore.get(1L), 100, 480);
    GT_Values.RA.addAssemblerRecipe(
        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24),
        GT_ItemList.DiamondFluidCoreChip.get(1L),
        GT_ItemList.EngineeringProcessorFluidDiamondCore.get(1L), 100, 1920);
    GT_Values.RA.addAssemblerRecipe(
        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24),
        GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L),
        GT_ItemList.EngineeringProcessorFluidEmeraldCore.get(1L), 100, 4096);

    GT_Values.RA.addAssemblerRecipe(
        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24),
        GT_ItemList.PulsatingSpatialCoreChip.get(1L),
        GT_ItemList.EngineeringProcessorSpatialPulsatingCore.get(1L), 100, 4096);

    // --- Storage Cell Component - 256K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 4),
            GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 4L, 38),
            ItemList.Circuit_Chip_NAND.get(4),
            GT_ItemList.EngineeringProcessorItemEmeraldCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 0), 200, 7680);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 3),
            GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 4L, 38),
            ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldAdvancedCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 0), 280, 30720);

    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 3),
            GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 3L, 38),
            ItemList.Circuit_Chip_SoC2.get(1), GT_ItemList.EmeraldAdvancedCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 0), 30, 122880);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 1),
            GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 2L, 38),
            ItemList.Circuit_Chip_SoC3.get(1), GT_ItemList.EngravedEnergyChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 0), 30, 500000);

    // --- Storage Cell Component - 1024K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 4),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 0),
            ItemList.Circuit_Chip_NAND.get(4),
            GT_ItemList.EngineeringProcessorItemEmeraldCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 1), 220, 7680);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 0),
            ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldAdvancedCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 1), 300, 30720);

    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 3L, 0),
            ItemList.Circuit_Chip_SoC2.get(1), GT_ItemList.EmeraldAdvancedCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 1), 30, 122880);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 1),
            GT_ModHandler.getModItem("extracells", "storage.component", 2L, 0),
            ItemList.Circuit_Chip_SoC3.get(1), GT_ItemList.EngravedEnergyChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 1), 30, 500000);

    // --- Storage Cell Component - 4096K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 4),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 1),
            ItemList.Circuit_Chip_NAND.get(4),
            GT_ItemList.EngineeringProcessorItemAdvEmeraldCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2), 240, 30720);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 1),
            ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldHighAdvancedCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2), 320, 122880);

    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 3L, 1),
            ItemList.Circuit_Chip_SoC3.get(1), GT_ItemList.EmeraldHighAdvancedCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2), 30, 500000);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Ultimate, 1),
            GT_ModHandler.getModItem("extracells", "storage.component", 2L, 1),
            ItemList.Circuit_Chip_SoC4.get(1), GT_ItemList.EngravedQuantumChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Phoenixite.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2), 30, 2000000);

    // --- Storage Cell Component - 16384K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Ultimate, 4),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 2),
            ItemList.Circuit_Chip_NAND.get(4),
            GT_ItemList.EngineeringProcessorItemAdvEmeraldCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 3), 260, 30720);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Ultimate, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 2),
            ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldHighAdvancedCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 3), 340, 122880);

    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Ultimate, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 3L, 2),
            ItemList.Circuit_Chip_SoC3.get(1), GT_ItemList.EmeraldHighAdvancedCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 3), 30, 500000);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Superconductor, 1),
            GT_ModHandler.getModItem("extracells", "storage.component", 2L, 2),
            ItemList.Circuit_Chip_SoC4.get(1), GT_ItemList.EngravedQuantumChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Phoenixite.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 3), 30, 2000000);

    // --- Fluid Storage Cell Component - 1K
    GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Chip_Ram.get(4),
            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lapis, 4),
            GT_ItemList.EngineeringProcessorFluidGoldCore.get(1L), GT_Utility.getIntegratedCircuit(1)},
        null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 4), 120, 480);
    GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Chip_NAND.get(3),
            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lapis, 4),
            GT_ItemList.GoldFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 4), 160, 1920);

    // --- Fluid Storage Cell Component - 4K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 4),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 4),
            ItemList.Circuit_Chip_Ram.get(4), GT_ItemList.EngineeringProcessorFluidGoldCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 5), 160, 480);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 4),
            ItemList.Circuit_Chip_NAND.get(3), GT_ItemList.GoldFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 5), 240, 1920);

    // --- Fluid Storage Cell Component - 16K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 4),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 5),
            ItemList.Circuit_Chip_Ram.get(4),
            GT_ItemList.EngineeringProcessorFluidDiamondCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 6), 180, 1920);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 5),
            ItemList.Circuit_Chip_NAND.get(3), GT_ItemList.DiamondFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 6), 260, 7680);

    GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Chip_Ram.get(32),
            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lapis, 32),
            ItemList.Circuit_Chip_SoC.get(1), GT_ItemList.DiamondFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Europium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 6), 30, 30720);
    GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Chip_NAND.get(16),
            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lapis, 16),
            ItemList.Circuit_Chip_SoC2.get(1), ItemList.Circuit_Parts_Crystal_Chip_Master.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 6), 30, 122880);

    // --- Fluid Storage Cell Component - 64K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 4),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 6),
            ItemList.Circuit_Chip_Ram.get(4),
            GT_ItemList.EngineeringProcessorFluidDiamondCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 7), 200, 1920);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 6),
            ItemList.Circuit_Chip_NAND.get(3), GT_ItemList.DiamondFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 7), 280, 7680);

    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 3L, 6),
            ItemList.Circuit_Chip_SoC.get(1), GT_ItemList.DiamondFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Europium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 7), 30, 30720);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 1),
            GT_ModHandler.getModItem("extracells", "storage.component", 2L, 6),
            ItemList.Circuit_Chip_SoC2.get(1), ItemList.Circuit_Parts_Crystal_Chip_Master.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 7), 30, 122880);

    // --- Fluid Storage Cell Component - 256K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 4),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 7),
            ItemList.Circuit_Chip_NAND.get(4),
            GT_ItemList.EngineeringProcessorFluidEmeraldCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 8), 200, 7680);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 7),
            ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 8), 280, 30720);

    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 3L, 7),
            ItemList.Circuit_Chip_SoC2.get(1), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 8), 30, 122880);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 1),
            GT_ModHandler.getModItem("extracells", "storage.component", 2L, 7),
            ItemList.Circuit_Chip_SoC3.get(1), ItemList.Circuit_Parts_Crystal_Chip_Master.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 8), 30, 500000);

    // --- Fluid Storage Cell Component - 1024K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 4),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 8),
            ItemList.Circuit_Chip_NAND.get(4),
            GT_ItemList.EngineeringProcessorFluidEmeraldCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 9), 220, 7680);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 8),
            ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 9), 300, 30720);

    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 3L, 8),
            ItemList.Circuit_Chip_SoC2.get(1), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 9), 30, 122880);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 1),
            GT_ModHandler.getModItem("extracells", "storage.component", 2L, 8),
            ItemList.Circuit_Chip_SoC3.get(1), ItemList.Circuit_Parts_Crystal_Chip_Master.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 9), 30, 500000);

    // --- Fluid Storage Cell Component - 4096K
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 4),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 9),
            ItemList.Circuit_Chip_NAND.get(4),
            GT_ItemList.EngineeringProcessorFluidEmeraldCore.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 10), 240, 30720);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 4L, 9),
            ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(1)}, null,
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 10), 320, 122880);

    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 3),
            GT_ModHandler.getModItem("extracells", "storage.component", 3L, 9),
            ItemList.Circuit_Chip_SoC3.get(1), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 10), 30, 500000);
    GT_Values.RA.addAssemblerRecipe(
        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Ultimate, 1),
            GT_ModHandler.getModItem("extracells", "storage.component", 2L, 9),
            ItemList.Circuit_Chip_SoC4.get(1), ItemList.Circuit_Parts_Crystal_Chip_Master.get(1L),
            GT_Utility.getIntegratedCircuit(2)}, Materials.Phoenixite.getMolten(36),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 10), 30, 2000000);

    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L),
        GT_ModHandler.getModItem("extracells", "storage.physical", 1L), 100, 7680);
    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 1),
        GT_ModHandler.getModItem("extracells", "storage.physical", 1L, 1), 100, 16384);
    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2),
        GT_ModHandler.getModItem("extracells", "storage.physical", 1L, 2), 100, 30720);
    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 3),
        GT_ModHandler.getModItem("extracells", "storage.physical", 1L, 3), 100, 65536);


    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L, 1),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 4),
        GT_ModHandler.getModItem("extracells", "storage.fluid", 1L), 100, 120);
    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L, 1),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 5),
        GT_ModHandler.getModItem("extracells", "storage.fluid", 1L, 1), 100, 256);
    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L, 1),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 6),
        GT_ModHandler.getModItem("extracells", "storage.fluid", 1L, 2), 100, 480);
    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L, 1),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 7),
        GT_ModHandler.getModItem("extracells", "storage.fluid", 1L, 3), 100, 1024);
    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L, 1),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 8),
        GT_ModHandler.getModItem("extracells", "storage.fluid", 1L, 4), 100, 7680);
    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L, 1),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 9),
        GT_ModHandler.getModItem("extracells", "storage.fluid", 1L, 5), 100, 16384);
    GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L, 1),
        GT_ModHandler.getModItem("extracells", "storage.component", 1L, 10),
        GT_ModHandler.getModItem("extracells", "storage.fluid", 1L, 6), 100, 30720);
    ...
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Wood, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "WOODWRIRONUpgrade", 1L, 0), 80, 8);
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "WRIRONSTEELUpgrade", 1L, 0), 90, 16);
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "STEELALUMINIUMUpgrade", 1L, 0), 100, 64);
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSLA, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "ALUMINIUMHSLAUpgrade", 1L, 0), 110, 256);
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSLA, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "HSLATITANIUMUpgrade", 1L, 0), 120, 1024);
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "TITANIUMWOLFRAMUpgrade", 1L, 0), 130, 4096);
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Chrome, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "WOLFRAMCHROMEUpgrade", 1L, 0), 140, 16384);
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Chrome, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "CHROMEIRIDIUMUpgrade", 1L, 0), 150, 65536);
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "IRIDIUMOSMIUMUpgrade", 1L, 0), 160, 262144);
    //GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium, 1), GT_Utility.getIntegratedCircuit(11)}, null, GT_ModHandler.getModItem("chestup", "OSMIUMNEUTRONIUMUpgrade", 1L, 0), 170, 1048576);
    ...
    for (int i = 0; i < 16; i++) {
      for (int j = 0; j < Dyes.VALUES[i].getSizeOfFluidList(); j++) {
        GT_Values.RA.addAssemblerRecipe(new ItemStack(Items.string, 3),
            ItemList.Circuit_Integrated.getWithDamage(0L, 3L, new Object[0]),
    ...
    for (int aTier = 10; aTier < 15; aTier++) {
      if (Loader.isModLoaded("bartworks")) {
        GT_Values.RA.addAssemblerRecipe(flInputs[aTier - 10],
            Materials.RadoxPolymer.getMolten((long) (2.25 * Math.pow(2, (aTier - 9)))),
