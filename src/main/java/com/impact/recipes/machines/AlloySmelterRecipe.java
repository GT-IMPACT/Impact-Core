...
public class AlloySmelterRecipe implements Runnable {
    ...
    public void run() {
        GT_Values.RA.addAlloySmelterRecipe(new ItemStack(Items.clay_ball, 1, 0), new ItemStack(Blocks.sand, 1, 0), CoreItems2.getRecipe(CokeOvenBrick.getMetaID(), 2), 200, 8);
