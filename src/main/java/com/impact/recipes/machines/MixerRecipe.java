...
/** ================================= start CORE MOD =================================*/
        //HastelloyC276
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel, 32L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Molybdenum, 8L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 7L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Cobalt, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tungsten, 1L), GT_Utility.getIntegratedCircuit(6), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.HastelloyC276, 49L), 150 * 20, 1920);
        //Potin
        ...
        GT_Values.RA.addMixerRecipe(CoreItems.getRecipe(28,8), Materials.MysteriousCrystal.getDust(2), Materials.Oriharukon.getDust(2), Materials.BlackPlutonium.getDustTiny(1), GT_Utility.getIntegratedCircuit(1), GT_Values.NI, Materials.Mutagen.getFluid(2000), Materials.BioMediumRaw.getFluid(1000), Materials.Diamond.getDustSmall(2), 200, 122880);
        GT_Values.RA.addMixerRecipe(CoreItems.getRecipe(35,8), Materials.MysteriousCrystal.getDust(2), Materials.Oriharukon.getDust(2), Materials.BlackPlutonium.getDustTiny(1), GT_Utility.getIntegratedCircuit(1), GT_Values.NI, Materials.Mutagen.getFluid(2000), Materials.BioMediumRaw.getFluid(1000), Materials.Diamond.getDustSmall(2), 200, 122880);
        GT_Values.RA.addMixerRecipe(CoreItems.getRecipe(28,32), Materials.MysteriousCrystal.getDust(8), Materials.Oriharukon.getDust(8), Materials.InfinityCatalyst.getDustTiny(1), GT_Utility.getIntegratedCircuit(2), GT_Values.NI, Materials.Mutagen.getFluid(8000), Materials.BioMediumRaw.getFluid(8000), Materials.Diamond.getDustTiny(2), 400, 122880);
        GT_Values.RA.addMixerRecipe(CoreItems.getRecipe(35,32), Materials.MysteriousCrystal.getDust(8), Materials.Oriharukon.getDust(8), Materials.InfinityCatalyst.getDustTiny(1), GT_Utility.getIntegratedCircuit(2), GT_Values.NI, Materials.Mutagen.getFluid(8000), Materials.BioMediumRaw.getFluid(8000), Materials.Diamond.getDustTiny(2), 400, 122880);
...
/** ================================= start GT =================================*/
        ...
        GT_Values.RA.addMixerRecipe(
                GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NitricAcid, 1L), GT_Values.NI, GT_Values.NI, GT_Values.NI,
