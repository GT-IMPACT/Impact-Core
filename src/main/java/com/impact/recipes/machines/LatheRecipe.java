...
public class LatheRecipe implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addLatheRecipe(new ItemStack(Blocks.cobblestone), CoreItems2.getRecipe(177,2), null, 100, 16);
        GT_Values.RA.addLatheRecipe(new ItemStack(Blocks.sandstone), CoreItems2.getRecipe(178,2), null, 100, 16);
