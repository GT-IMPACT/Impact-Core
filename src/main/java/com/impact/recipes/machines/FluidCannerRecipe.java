...
import static com.impact.common.item.Core_List_Items.Empty1080SpCell;
import static com.impact.common.item.Core_List_Items.Empty180SpCell;
import static com.impact.common.item.Core_List_Items.Empty360SpCell;
import static com.impact.common.item.Core_List_Items.Empty540SpCell;
...
/** ================================= start GT =================================*/
    ...
    GT_Values.RA.addFluidCannerRecipe(
        ...
        GT_ModHandler.getModItem("GalacticraftCore", "item.oxygenTankLightFull", 1L, 0),
            FluidRegistry.getFluidStack("liquidoxygen", 1800), GT_Values.NF);
    GT_Values.RA.addFluidCannerRecipe(
        ...
        GT_ModHandler.getModItem("GalacticraftCore", "item.oxygenTankMedFull", 1L, 0),
            FluidRegistry.getFluidStack("liquidoxygen", 3600), GT_Values.NF);
    GT_Values.RA.addFluidCannerRecipe(
        ...
        GT_ModHandler.getModItem("GalacticraftCore", "item.oxygenTankHeavyFull", 1L, 0),
            FluidRegistry.getFluidStack("liquidoxygen", 5400), GT_Values.NF);
    GT_Values.RA.addFluidCannerRecipe(
        ...
        GT_ModHandler.getModItem("GalacticraftCore", "item.oxygenTankt4", 1L, 0),
            FluidRegistry.getFluidStack("liquidoxygen", 7200), GT_Values.NF);
    GT_Values.RA.addFluidCannerRecipe(
        ...
        GT_ModHandler.getModItem("GalacticraftCore", "item.oxygenTankt5", 1L, 0),
            FluidRegistry.getFluidStack("liquidoxygen", 9000), GT_Values.NF);
    GT_Values.RA.addFluidCannerRecipe(
        ...
        GT_ModHandler.getModItem("GalaxySpace", "item.oxygentank_t4", 1L, 0),
            FluidRegistry.getFluidStack("liquidoxygen", 10800), GT_Values.NF);
    GT_Values.RA.addFluidCannerRecipe(
        ...
        GT_ModHandler.getModItem("GalaxySpace", "item.oxygentank_t5", 1L, 0),
            FluidRegistry.getFluidStack("liquidoxygen", 12600), GT_Values.NF);
    GT_Values.RA.addFluidCannerRecipe(
        ...
        GT_ModHandler.getModItem("GalaxySpace", "item.oxygentank_t6", 1L, 0),
            FluidRegistry.getFluidStack("liquidoxygen", 14400), GT_Values.NF);
