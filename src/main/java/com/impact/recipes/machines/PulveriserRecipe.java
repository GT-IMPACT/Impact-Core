...
/** ================================= start SPARTAK CORE =================================*/
    ...
    GT_Values.RA.addPulveriserRecipe(
        ...
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustDeimos", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Magnesite, 1)},
        new int[]{10000, 5000}, 400, 64);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "ceresblocks", 1L, 0),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "ceresblocks", 1L, 1),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustCeres", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.MeteoricIron, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Beryllium, 1)},
        new int[]{10000, 5000, 2500}, 400, 120);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "europablocks", 1L, 1),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "europablocks", 1L, 2),
    ...
    GT_Values.RA.addPulveriserRecipe(
        ...
        new int[]{10000, 5000, 2500}, 400, 120);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "europablocks", 1L, 0),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustEuropa", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.SiliconDioxide, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Iron, 1)},
        new int[]{10000, 5000, 2000}, 400, 120);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "europageyser", 1L, 0),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustEuropa", 1),
    ...
    GT_Values.RA
        .addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "callistoblocks", 1L, 1),
            new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustIceCallisto", 1),
                GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Galena, 1)},
            new int[]{10000, 5000, 2500}, 400, 120);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "ioblocks", 1L, 0),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "ioblocks", 1L, 7),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustIo", 1),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "ioblocks", 1L, 1),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustIo", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Ash, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Sulfur, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Tantalite, 1)},
        new int[]{10000, 5000, 3000, 2000}, 400, 256);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "ioblocks", 1L, 8),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustIo", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Ash, 2),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Sulfur, 2),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Tantalite, 2)},
        new int[]{10000, 5000, 4000, 3000}, 400, 256);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "ioblocks", 1L, 2),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustIo", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Sulfur, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Tantalite, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Tungsten, 1)},
        new int[]{10000, 5000, 2500, 1500}, 400, 256);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "venusblocks", 1L, 0),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "venusblocks", 1L, 1),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustVenus", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Tetrahedrite, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Scheelite, 1)},
        new int[]{10000, 4500, 2500, 1500}, 400, 256);
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "titanblocks", 1L, 0),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "titanblocks", 1L, 1),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustTitan", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Nickel, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Iridium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Osmium, 1)},
        new int[]{10000, 4500, 3000, 2000}, 400, 480);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "titanblocks", 1L, 2),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustTitan", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Nickel, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Iridium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Osmium, 1)},
    ...
    GT_Values.RA.addPulveriserRecipe(
        ...
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustProteus", 1),
            ...
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Draconium, 1)},
        new int[]{10000, 5000, 2500, 1000}, 400, 1024);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "tritonblocks", 1L, 0),
        ...
        new int[]{10000, 5000, 2500, 1000}, 400, 1024);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "tritonblocks", 1L, 1),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustTriton", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Gold, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Neodymium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.RareEarth, 1)},
        new int[]{10000, 5000, 2500, 1000}, 400, 1024);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "tritonblocks", 1L, 2),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustTriton", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Gold, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Neodymium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.RareEarth, 1)},
        new int[]{10000, 5000, 2500, 1000}, 400, 1024);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "tritonblocks", 1L, 3),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustTriton", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Gold, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Neodymium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.RareEarth, 1)},
        new int[]{10000, 5000, 2500, 1000}, 400, 1024);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "tritonblocks", 1L, 4),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustTriton", 1),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "plutoblocks", 1L, 0),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "plutoblocks", 1L, 1),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustIcePluto", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Thorium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Uranium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Plutonium, 1)},
        new int[]{10000, 5000, 2500, 1250}, 400, 1920);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "plutoblocks", 1L, 2),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustIcePluto", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Thorium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Uranium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Plutonium, 1)},
        new int[]{10000, 5000, 2500, 1250}, 400, 1920);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "plutoblocks", 1L, 3),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustIcePluto", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Thorium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Uranium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Plutonium, 1)},
        new int[]{10000, 5000, 2500, 1250}, 400, 1920);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "plutoblocks", 1L, 4),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustIcePluto", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Thorium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Uranium, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Plutonium, 1)},
        new int[]{10000, 5000, 2500, 1250}, 400, 1920);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "plutoblocks", 1L, 5),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "vegabgrunt", 1L, 0),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustVegaB", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Uranium235, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Plutonium241, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Europium, 1)},
    ...
    GT_Values.RA
        .addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "barnardaFsubgrunt", 1L, 0),
            new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustBarnardaF", 1),
                ...
                GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Niobium, 1)},
            new int[]{10000, 2500, 2000, 1500}, 400, 4096);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "tcetieblocks", 1L, 0),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustTCetiE", 1),
            ...
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.BlackPlutonium, 1)},
        new int[]{10000, 2500, 2000, 1500}, 400, 4096);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "tcetieblocks", 1L, 1),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustTCetiE", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Lapis, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Apatite, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.BlackPlutonium, 1)},
        new int[]{10000, 2500, 2000, 1500}, 400, 4096);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "tcetieblocks", 1L, 2),
        new ItemStack[]{GregTech_API.getStackofAmountFromOreDict("dustTCetiE", 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Lapis, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Apatite, 1),
            GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.BlackPlutonium, 1)},
...
/** ================================= start CUSTOM RECIPES =================================*/
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("TConstruct", "materials", 1L, 2),
        new ItemStack[]{CoreItems.getRecipe(32, 1)}, new int[]{10000}, 300, 2);
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("TConstruct", "GlassBlock", 1L, 0),
        new ItemStack[]{CoreItems.getRecipe(33, 1)}, new int[]{10000}, 300, 2);

    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "barnardaClog", 1L),
    ...
    GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("GalaxySpace", "barnardaCleaves", 8L),
    ...
    GT_Values.RA.addPulveriserRecipe(CoreItems2.getRecipe(152, 1),
