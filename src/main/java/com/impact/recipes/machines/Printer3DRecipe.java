...
/** ================================= start IMPACT MOD =================================*/
        ...
        GT_Values.RA.addBasicLineRecipe(new ItemStack[]{
                ...
                ItemList.Electric_Piston_IV.get(4L), ItemList.Robot_Arm_IV.get(4L), ItemList.Emitter_IV.get(4L), ItemList.Conveyor_Module_IV.get(4L),
                GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Inconel690, 8), GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.HSSG, 4), GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Nitinol, 4), GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Nitinol, 8),
                GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.HSSG, 8), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSE, 16), GT_OreDictUnificator.get(OrePrefixes.screw, Materials.HSSE, 16)
        ...
        GT_Values.RA.addBasicLineRecipe(new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Inconel792, 1), ItemList.EnergyCrystal_IV.get(1L), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Platinum, 8), ItemList.Circuit_Chip_PIC.get(12L),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.TungstenSteel, 32), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HastelloyC276, 64), GT_OreDictUnificator.get(OrePrefixes.screw, Materials.HSSG, 64)
...
/** ================================= start GT =================================*/
        ...
        GT_Values.RA.addPrimitiveLineRecipe(new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Polytetrafluoroethylene, 2), GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 4),
        ...
        GT_Values.RA.addBasicLineRecipe(new ItemStack[]{
                ItemList.Cover_SolarPanel_IV.get(1L), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Polybenzimidazole, 8), ItemList.Circuit_Chip_UHPIC.get(6L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 10),
        ...
        GT_Values.RA.addBasicLineRecipe(new ItemStack[]{
                ItemList.Cover_SolarPanel_LuV.get(1L), GT_OreDictUnificator.get(OrePrefixes.plateTriple, Materials.Polybenzimidazole, 10), ItemList.Circuit_Chip_QPIC.get(8L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 12),
        ...
        GT_Values.RA.addBasicLineRecipe(new ItemStack[]{
                ItemList.Cover_SolarPanel_ZPM.get(1L), GT_OreDictUnificator.get(OrePrefixes.plateQuadruple, Materials.Polybenzimidazole, 12), ItemList.Circuit_Chip_FPIC.get(10L), GT_OreDictUnificator.get(OrePrefixes.plateAlloy, Materials.Carbon, 14),
