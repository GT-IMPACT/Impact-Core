...
public class AutoclaveRecipe implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addAutoclaveSpaceRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.MysteriousCrystal, 9L), Materials.EnrichedBacterialSludge.getFluid(1000L), GT_ModHandler.getModItem("GalaxySpace","item.BasicItems",1L, 10), 10000, 2000, 7680, true);
    }
}
