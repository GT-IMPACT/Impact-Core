...
public class AfterGregTechPostLoadRecipes implements Runnable {
    ...
    public void run() {
        ...
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "door_acacia", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "door_birch", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "door_dark_oak", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "door_jungle", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "door_spruce", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "wood_sliding_door", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "iron_sliding_door", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "jail_door", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "laboratory_door", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "factory_door", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "shoji_door", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_purple", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_yellow", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_magenta", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_pink", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_white", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_blue", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_gray", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_cyan", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_red", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_brown", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_lime", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_orange", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_silver", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_green", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_light_blue", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "curtain_black", 1L, 0), true, false, false);
        removeRecipeByOutput(GT_ModHandler.getModItem("malisisdoors", "saloon", 1L, 0), true, false, false);
