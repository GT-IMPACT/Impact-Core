package com.impact.GregTech.casings.glass1;

        import com.impact.GregTech.GTregister.GT_ItemList;
...
public class GT_Block_Glass1
    ...
    public GT_Block_Glass1() {
        ...
        int CS = 0;
        GT_ItemList.GLASS_CASSING_1.set(new ItemStack(this, 1, CS++));
        GT_ItemList.GLASS_CASSING_2.set(new ItemStack(this, 1, CS++));
        setLightOpacity(0);
    }
