...
import com.impact.GregTech.tileentities.multi.gui.GUI_PressBendExtrud;
...
public class GT_TileEntity_PressBendExtrud extends GT_MetaTileEntity_MultiParallelBlockBase {
    ...
    /** === NAMED === */
    public GT_TileEntity_PressBendExtrud(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    /** === NAMED === */
    public GT_TileEntity_PressBendExtrud(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_PressBendExtrud(this.mName);
    }
