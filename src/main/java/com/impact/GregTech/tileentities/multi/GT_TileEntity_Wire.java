...
import com.impact.GregTech.tileentities.multi.gui.GUI_Wire;
...
public class GT_TileEntity_Wire extends GT_MetaTileEntity_MultiParallelBlockBase {
    ...
    /** === NAMED === */
    public GT_TileEntity_Wire(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    /** === NAMED === */
    public GT_TileEntity_Wire(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_Wire(this.mName);
    }
