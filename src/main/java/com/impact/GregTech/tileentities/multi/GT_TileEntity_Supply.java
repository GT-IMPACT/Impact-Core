...
import com.impact.GregTech.tileentities.multi.gui.GUI_Supply;
...
public class GT_TileEntity_Supply extends GT_MetaTileEntity_MultiParallelBlockBase {
    ...
    /** === NAMED === */
    public GT_TileEntity_Supply(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    /** === NAMED === */
    public GT_TileEntity_Supply(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_Supply(this.mName);
    }
...
//        } else
    ...
    public void onScrewdriverRightClick(byte aSide, EntityPlayer aPlayer, float aX, float aY, float aZ) {
        ...
        mModed = (mMode == 0 ? " Autoclave " : mMode == 1 ? " Dust Washer " : mMode == 2 ? " Ore Washer " : mMode == 3 ? " Chemical Bath " : null);
