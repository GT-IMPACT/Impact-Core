...
import com.impact.GregTech.tileentities.multi.gui.GUI_Utility;
...
public class GT_TileEntity_Utility extends GT_MetaTileEntity_MultiParallelBlockBase {
    ...
    /** === NAMED === */
    public GT_TileEntity_Utility(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    /** === NAMED === */
    public GT_TileEntity_Utility(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_Utility(this.mName);
    }
