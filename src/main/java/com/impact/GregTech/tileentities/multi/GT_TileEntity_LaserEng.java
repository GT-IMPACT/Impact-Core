...
import com.impact.GregTech.tileentities.multi.gui.GUI_NotMultiMachine;
...
public class GT_TileEntity_LaserEng extends GT_MetaTileEntity_MultiParallelBlockBase {
    ...
    /** === NAMED === */
    public GT_TileEntity_LaserEng(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    /** === NAMED === */
    public GT_TileEntity_LaserEng(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_LaserEng(this.mName);
    }
