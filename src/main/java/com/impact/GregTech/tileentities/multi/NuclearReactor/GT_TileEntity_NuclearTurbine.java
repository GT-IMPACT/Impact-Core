package com.impact.GregTech.tileentities.multi.NuclearReactor;
...
public class GT_TileEntity_NuclearTurbine extends GT_MetaTileEntity_MultiBlockBase {
    ...
    public GT_TileEntity_NuclearTurbine(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public GT_TileEntity_NuclearTurbine(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_NuclearTurbine(mName);
    }
