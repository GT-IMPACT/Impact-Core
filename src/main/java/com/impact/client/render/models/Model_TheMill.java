...
public class Model_TheMill extends ModelBase {
	...
	public Model_TheMill() {
		...
		this.setRotateAngle(this.sail1, 0.0F, -0.2617994F, 0.0F);
		...
		this.setRotateAngle(this.sail3, 0.0F, 0.2617994F, 0.0F);
		...
		this.setRotateAngle(this.sail4, -0.2617994F, -0.0F, 0.0F);
		...
		this.setRotateAngle(this.sail2, 0.2617994F, -0.0F, 0.0F);
