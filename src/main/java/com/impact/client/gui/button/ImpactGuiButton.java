...
public class ImpactGuiButton extends GuiButton {
  ...
  protected static final ResourceLocation buttonTextures = new ResourceLocation(
      "impact:textures/gui/widgets/widgets.png");
  ...
  public void drawButton(Minecraft mc, int x, int y) {
    if (this.visible) {
      ...
      this.field_146123_n =
          x >= this.xPosition && y >= this.yPosition && x < this.xPosition + this.width
      ...
      this.drawTexturedModalRect(this.xPosition, this.yPosition, 0, 46 + k * 20, this.width / 2,
          this.height);
