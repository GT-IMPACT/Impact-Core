...
public class Block_CollisionBlocks extends gtUpdateBlockAPI {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World world, int x, int y, int z) {
        ...
        if (meta == 0) {
            ...
            return AxisAlignedBB.getBoundingBox((double) x + 0.200F, (double) y + this.minY, (double) z + 0.200F, (double) x + 0.800F, (double) y + this.maxY, (double) z + 0.800F);
        } else {
            return AxisAlignedBB.getBoundingBox((double) x + this.minX, (double) y + this.minY, (double) z + this.minZ, (double) x + this.maxX, ((float) y + this.maxY), (double) z + this.maxZ);
        }
    }
