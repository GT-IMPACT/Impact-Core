package com.impact.addon.rc.carts.base;
...
/**
 * Abstract minecart class that implements the IItemTransfer interface for convenience and as
 * example for others who wish to create carts that implements IItemTransfer. This particular
 * implementation assumes a simple inventory and will attempt to pass along offers and requests to
 * linked carts if it cannot fulfill them itself. <br/> <br/> Classes that extend this class:<br/>
 * EntityCartChest<br/> EntityCartAnchor<br/>
 *
