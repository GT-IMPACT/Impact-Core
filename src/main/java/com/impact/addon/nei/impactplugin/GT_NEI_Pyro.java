...
public class GT_NEI_Pyro
    ...
    public TemplateRecipeHandler newInstance() {
        return new GT_NEI_Pyro(this.mRecipeMap);
    }
    ...
    public class CachedDefaultRecipe
        ...
        public CachedDefaultRecipe(GT_Recipe aRecipe) {
            ...
            int index = 0;
            for (FluidStack mFluidOutput : aRecipe.mFluidOutputs) {
                if (mFluidOutput != null && mFluidOutput.getFluid() != null) {
                    int x = index == 4 ? 104 : 127;
                    int y = index == 4 ? 27 : index * 18;
                    this.mOutputs.add(new FixedPositionedStack(GT_Utility.getFluidDisplayStack(mFluidOutput, true), x, y));
                    index++;
                }
            }
        }
