...
import static com.gwppcore.guihandler.GUIHandler.GUI_ID_TiChest;


public final class ChestTi extends BaseChest
{
	public static final ChestTi instance = new ChestTi();

	private ChestTi()
	{
		super(Material.iron);
		setBlockName("TitaniumChest")
		.setHardness(5.0F)
	...
	{
		if (!world.isRemote)
			FMLNetworkHandler.openGui(entityPlayer, gwppcore.instance, GUI_ID_TiChest, world, x, y, z);
		return true;
	}
