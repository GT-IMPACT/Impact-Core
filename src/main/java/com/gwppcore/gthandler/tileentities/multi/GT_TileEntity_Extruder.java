...
public class GT_TileEntity_Extruder extends GT_MetaTileEntity_MultiParallelBlockBase {

    /** === SET TEXTURES HATCHES AND CONTROLLER === */
    ITexture INDEX_CASE = Textures.BlockIcons.casingTexturePages[3][7];
    int INDEX_CASE1 = 391;
    /** === SET BLOCKS STRUCTURE === */
    Block INDEX_PAGE = GT_Container_CasingsParall.sBlockCasingsParall;
    byte INDEX_CASE_PAGE = 7;
    ...
    /** === NAMED === */
    public GT_TileEntity_Extruder(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    /** === NAMED === */
    public GT_TileEntity_Extruder(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_Extruder(this.mName);
    }
