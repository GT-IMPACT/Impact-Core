...
public class GT_TileEntity_CircuitAssembler extends GT_MetaTileEntity_MultiParallelBlockBase {

    /** === SET TEXTURES HATCHES AND CONTROLLER === */
    ITexture INDEX_CASE = Textures.BlockIcons.casingTexturePages[3][9];
    int INDEX_CASE1 = 393;
    /** === SET BLOCKS STRUCTURE === */
    Block INDEX_PAGE = GT_Container_CasingsParall.sBlockCasingsParall;
    byte INDEX_CASE_PAGE = 9;
    ...
    /** === NAMED === */
    public GT_TileEntity_CircuitAssembler(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    /** === NAMED === */
    public GT_TileEntity_CircuitAssembler(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_CircuitAssembler(this.mName);
    }
