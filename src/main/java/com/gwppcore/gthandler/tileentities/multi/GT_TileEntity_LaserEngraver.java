...
public class GT_TileEntity_LaserEngraver extends GT_MetaTileEntity_MultiParallelBlockBase {
    ...
    /** === NAMED === */
    public GT_TileEntity_LaserEngraver(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    /** === NAMED === */
    public GT_TileEntity_LaserEngraver(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_LaserEngraver(this.mName);
    }
    ...
    public String[] getDescription() {
        ...
        b
                ...
                .addCasingInfo("Laser Engraver Casing", 20)
