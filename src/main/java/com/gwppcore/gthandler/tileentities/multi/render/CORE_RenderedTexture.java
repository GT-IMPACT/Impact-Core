package com.gwppcore.gthandler.tileentities.multi.render;

import com.gwppcore.gthandler.tileentities.multi.IFrontRotation;
...
public class CORE_RenderedTexture implements ITexture,IColorModulationContainer {
    ...
    public CORE_RenderedTexture(IIconContainer aIcon, short[] aRGBa, boolean aAllowAlpha) {
        if (aRGBa.length != 4) throw new IllegalArgumentException("RGBa doesn't have 4 Values @ CORE_RenderedTexture");
        mIconContainer = aIcon;
        mAllowAlpha = aAllowAlpha;
        mRGBa = aRGBa;
    }

    public CORE_RenderedTexture(IIconContainer aIcon, short[] aRGBa) {
        this(aIcon, aRGBa, true);
    }

    public CORE_RenderedTexture(IIconContainer aIcon) {
