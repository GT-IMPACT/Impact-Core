package com.gwppcore.GregTech.casings.glass1.glassed;
...
public final class GlassBlocksRender implements ISimpleBlockRenderingHandler {
    @Override
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
        ...
        //South
        if (world.getBlock(x, y, z + 1).getClass() != GlassBlocks.class) {
        ...
        //East
        if (world.getBlock(x + 1, y, z).getClass() != GlassBlocks.class) {
        ...
        //Top
        if (world.getBlock(x, y + 1, z).getClass() != GlassBlocks.class) {
