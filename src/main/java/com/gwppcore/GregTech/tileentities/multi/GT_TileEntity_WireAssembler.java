...
public class GT_TileEntity_WireAssembler extends GT_MetaTileEntity_MultiParallelBlockBase {

    /** === SET BLOCKS STRUCTURE === */
    Block INDEX_PAGE = CORE_API.sCaseCore1;
    byte INDEX_CASE_PAGE = 10;
    ...
    /** === NAMED === */
    public GT_TileEntity_WireAssembler(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    /** === NAMED === */
    public GT_TileEntity_WireAssembler(String aName) {
        super(aName);
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_TileEntity_WireAssembler(this.mName);
    }
    ...
    public String[] getDescription() {
        ...
        b
                ...
                .addCasingInfo("Wire Assembling Casing", 19)
