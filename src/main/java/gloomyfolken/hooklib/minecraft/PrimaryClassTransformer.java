...
/**
 * Этим трансформером трансформятся все классы, которые грузятся раньше майновских. В момент начала
 * загрузки майна (точнее, чуть раньше - в Loader.injectData) все хуки отсюда переносятся в
 * MinecraftClassTransformer. Такой перенос нужен, чтобы трансформеры хуклибы применялись последними
 * - в частности, после деобфускации, которую делает фордж.
 */
