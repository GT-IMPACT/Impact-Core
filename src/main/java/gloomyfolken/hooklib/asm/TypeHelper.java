...
/**
 * Класс, позволяющий создавать типы из разных входных данных. Эти типы нужны для того, чтобы
 * задавать параметры и возвращаемые значения методов.
 */
public class TypeHelper {
  ...
  /**
   * Создает тип для одномерного массива указанного класса или примитиа. Пример использования:
   * getArrayType("net.minecraft.world.World") - вернёт тип для World[]
   *
   * @param className необфусцированное название класса
  ...
  /**
   * Создает тип для n-мерного массива указанного класса или примитива. Пример использования:
   * getArrayType("net.minecraft.world.World", 2) - вернёт тип для World[][]
   *
